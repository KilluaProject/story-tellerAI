  ...
  return (
    <header className='container relative pt-16'>
        ...
        <div className='flex gap-2 absolute -top-5 right-5'>
            <Link href={'/'}>
                <FilePen className='w-8 h-8 lg:w-9 lg:h-9 mx-auto text-purple-500 mt-10 border border-purple-500 rounded-md p-2 hover:opacity-50 cursor-pointer'/>
            </Link>

            <Link href={'/stories'}>
                <BookOpen className='w-8 h-8 lg:w-9 lg:h-9 mx-auto text-purple-500 mt-10 border border-purple-500 rounded-md p-2 hover:opacity-50 cursor-pointer' />
            </Link>
        </div>
    </header>
  )
