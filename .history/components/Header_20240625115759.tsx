...
const Header = () => {
  return (
    <header className='container relative pt-16'>
        <Link href={'/'}>
            <h1 className='text-center'>Story Teller AI</h1>
            <div className='flex space-x-5 text-3xl lg:text-5xl justify-center items-center'>
                <h2 className='text-6xl font-black '>Bringing your stories</h2>
