  ...
  return (
    <header className='container relative pt-16'>
        ...
        <div>
            ...
            <Link>
                <BookOpen className='w-8 h-8 lg:w-10 lg:h-10 mx-auto text-purple-500 mt-10 border border-purple-500 rounded-md p-2 hover:opacity-50 cursor-pointer' href='/stories/>
            </Link>
        </div>
    </header>
  )
